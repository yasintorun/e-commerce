        ...
        <div className="carousel relative container mx-auto" style="max-width:1600px;">
            <div className="carousel-inner relative overflow-hidden w-full">
                ...
                <div className="carousel-item absolute opacity-0" style="height:50vh;">
                    <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=crop&w=1600&q=80');">
                ...
                <div className="carousel-item absolute opacity-0 bg-cover bg-right" style="height:50vh;">
                    <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://images.unsplash.com/photo-1533090161767-e6ffed986c88?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjM0MTM2fQ&auto=htmlFormat&fit=crop&w=1600&q=80');">
                ...
                <div className="carousel-item absolute opacity-0" style="height:50vh;">
                    <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom" style="background-image: url('https://images.unsplash.com/photo-1519327232521-1ea2c736d34d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=crop&w=1600&q=80');">
